...
import { closest, debug, columnsInRow } from './util';
...
`
  ...
  selectTalk(hash, fadeInClass) {
    ...
    if (talk) {
      ...
      $tr.insertAdjacentElement('afterEnd', new TalkDetailsRow(talk.contents).render(columns));
